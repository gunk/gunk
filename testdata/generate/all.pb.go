...
func (x *UtilTestRequest) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *UtilTestRequest) GetDuration() *duration.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
var file_testdata_tld_util_all_proto_rawDesc = []byte{
	...
	0x90, 0x02, 0x00, 0x28, 0x00, 0x30, 0x00, 0x1a, 0x03, 0x88, 0x02, 0x00, 0x42, 0x2c, 0x48, 0x01,
	0x50, 0x00, 0x5a, 0x11, 0x74, 0x65, 0x73, 0x74, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x74, 0x6c, 0x64,
	0x2f, 0x75, 0x74, 0x69, 0x6c, 0x80, 0x01, 0x00, 0x88, 0x01, 0x00, 0x90, 0x01, 0x00, 0xb8, 0x01,
